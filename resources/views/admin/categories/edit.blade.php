...
@section('page-description', 'Cập nhật thông tin, thumbnail, danh mục cha và trạng thái hiển thị.')
    ...
    <div class="grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,2fr)_minmax(320px,1fr)]">
        <div class="space-y-6">
            <section class="rounded-xl border border-gray-200 bg-white p-5 sm:p-6">
                <div class="mb-5 border-b border-gray-100 pb-4">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Cập nhật tên, slug, danh mục cha và mô tả.
                    </p>
                </div>
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        <label for="parent_id" class="mb-1.5 block text-sm font-medium text-gray-700">
                            Danh mục cha
                        </label>
                        ...
                        <p class="mt-1 text-xs text-gray-500">
                            Hệ thống đã loại chính danh mục này và toàn bộ danh mục con khỏi danh sách để tránh vòng lặp.
                        </p>
        ...
        <aside class="space-y-6">
            <section class="rounded-xl border border-gray-200 bg-white p-5">
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Kiểm soát khả năng hiển thị của danh mục.
                </p>
            ...
            <section class="rounded-xl border border-blue-200 bg-blue-50 p-5">
                ...
                <ul class="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-blue-800">
                    ...
                    <li>
                        Không thể chọn danh mục con của nó làm danh mục cha.
                    </li>

                    <li>
                        Nếu chọn ảnh mới, ảnh cũ sẽ được xóa sau khi cập nhật thành công.
                    </li>
                </ul>
            </section>
